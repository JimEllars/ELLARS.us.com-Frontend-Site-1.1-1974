      ...
      <section className="max-w-7xl mx-auto px-6 mb-32">
        <div className="mb-12 border-b border-phthalo-deep pb-4">
          <h3 className="font-editorial text-3xl text-white uppercase font-bold flex items-center">
            <SafeIcon name="Briefcase" className="w-6 h-6 mr-4 text-phthalo-glow" />
            Operational History
          </h3>
        </div>
        ...
        >
          {historyData.map((item, index) => (
            <motion.div key={index} variants={itemVariants} className="interactive-card p-8 bg-black/40 backdrop-blur-sm  relative overflow-hidden group">
              ...
              <div className="text-phthalo-glow font-editorial text-sm font-bold tracking-widest mb-2">{item.year}</div>
