...
const AutomationCalculator = () => {
  ...
  useEffect(() => {
    try {
      ...
      if (wasClamped) {
        toast("Notice: Shared metrics parameters adjusted safely to meet platform operating bounds.", { toastId: "calc-bounds-alert",
            ...
            <div className="bg-void border border-white/5 p-4 mt-4 text-[10px] font-mono text-gray-400 uppercase tracking-widest overflow-x-auto">
              ...
              <div className="mt-4 pt-4 border-t border-white/5 flex justify-end print:hidden">
                ...
                <button
                  ...
                  className="text-yellow-electric/70 hover:text-yellow-electric transition-colors flex items-center gap-1 focus:ring-2 focus:ring-yellow-electric/80 focus:ring-offset-2 focus:outline-none mr-4"
                >
