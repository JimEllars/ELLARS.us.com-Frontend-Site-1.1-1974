      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <form className="flex flex-col sm:flex-row gap-4 justify-center max-w-2xl mx-auto">
          <input 
            ...
            required 
          />
          <button type="submit" className="bg-white text-black font-editorial font-bold text-xs uppercase tracking-widest px-10 py-5 hover:bg-gold-bright transition-colors rounded-sm shadow-xl">Join the Newsletter</button>
        </form>
      </div>
    </section>
  );
